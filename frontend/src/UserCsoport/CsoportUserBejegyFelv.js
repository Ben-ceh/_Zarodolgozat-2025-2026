...
import CsoportUserLenyiloHelyszin from "./CsoportUserLenyiloHelyszin";
import CsoportUserLenyiloCsoportjaim from "./CsoportUserLenyiloCsoportjaim";

const CsoportUserBejegyFelv = ({ onSuccess }) => {
  ...
  return (
    ...
    <div className="card p-3 mb-3">
      ...
      />
        {/*Kategória */}
        <CsoportUserLenyiloKategoria value={kategoria} kivalasztott={setKivalasztottKat} />
       
        {/*Település*/}
        <CsoportUserLenyiloHelyszin value={helyszin} kivalasztott={setKivalasztottHely} />

        {/*Csoportjaim*/}
        <CsoportUserLenyiloCsoportjaim value={csoportjaim} userid={userid} kivalasztott={setKivalasztottCsop} />
...
export default CsoportUserBejegyFelv;
